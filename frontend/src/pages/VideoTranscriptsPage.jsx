...
export default function VideoTranscriptsPage() {
    ...
    return (
        <Layout headerName={"Transcripts"} tabName={"Video Transcripts"}>
            ...
            {transcriptInfo["id"] && <div className="grid">
                ...
                <div className="h-96 overflow-y-auto border border-black rounded-md">
                    <ol className="list-decimal space-y-2 justify-self-center">
